...
cfg_if! {
    ...
    } else if #[cfg(any(target_os = "linux", target_os = "vibix", target_os = "emscripten", target_os = "hurd", target_os = "redox", target_os = "dragonfly"))] {
...
#[cfg(any(target_os = "android", target_os = "linux", target_os = "vibix"))]
