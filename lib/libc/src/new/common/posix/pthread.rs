...
extern "C" {
    #[cfg(any(target_os = "android", any(target_os = "linux", target_os = "vibix")))]
    ...
    #[cfg(any(target_os = "android", target_os = "l4re", any(target_os = "linux", target_os = "vibix")))]
    ...
    #[cfg(any(
        target_os = "android",
        target_os = "l4re",
        any(target_os = "linux", target_os = "vibix"),
        target_vendor = "apple",
    ))]
    ...
    #[cfg(any(target_os = "l4re", any(target_os = "linux", target_os = "vibix"), target_vendor = "apple"))]
    ...
    #[cfg(any(target_os = "l4re", all(any(target_os = "linux", target_os = "vibix"), not(target_env = "ohos"))))]
    pub fn pthread_cancel(thread: crate::pthread_t) -> c_int;

    #[cfg(any(target_os = "android", target_os = "emscripten", any(target_os = "linux", target_os = "vibix"),))]
    ...
    #[cfg(all(any(target_os = "linux", target_os = "vibix"), not(target_env = "ohos")))]
    ...
    #[cfg(any(target_os = "linux", target_os = "vibix"))]
    ...
    #[cfg(any(target_os = "l4re", any(target_os = "linux", target_os = "vibix")))]
